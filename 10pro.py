...
#=============
cl = LineClient(authToken="EGymFXc5KqDLISUGlAk2.WoXuSNFRxJJ4y5tpLNBYaG.A7LW1f6cF6FwLb4s6uqJ4eosrlnUw0hqrAFpoBjeW8E=")
...
ki = LineClient(authToken="EGwuGNZTxgmKzzdvCm4d.UTyjPKxsevBlRp3J8QqDNq.jV/KkHhas6wsbm2Whr5rDw3kSQ5jiyJXm+OgpJ61M+w=")
...
kk = LineClient(authToken="EGUBPsF3spUFGUHKr6A7.t/IdFcgcW7pVEtQdsL6WzW.RNfWckzrDEZ5x+IHDYvm9X5g5ofFlbaUXSXC+SI+11k=")
...
kc = LineClient(authToken="EGquKB2DYe3Xe3JmbS41.f04Z5tIwN8oo0wvkaqNsqq.E4N9wyljwo5CprGjwvzBpYIsRQwZVTMC39veuB33bik=")
...
km = LineClient(authToken="EGQJi6oMnbysh2r8M8r5.hY1gor5CBWozmN09XaJ2nq.hBg4VjF/4n3GJHsH58o4PVaeBai5pBbLgtKpafswICc=")
...
kb = LineClient(authToken="EGiuReAucQsVEKSNatQd.JZJ/1Jhb9oyNKqIA+uiyFq.QJ9tVWrZMmhyyulcm7R6vSZVk9u4ZUhWn4aoJ5k/Jys=")
...
kn = LineClient(authToken="EGlC1pdwAXgJa8ifvhQa.uA70OmZ6xGXhLjifkBHlgG.wqHsMSr4AfbP8t5NwXO1XPvkDkc2PLshNy8PWSzm9S0=")
...
ko = LineClient(authToken="EGHVHQWEY3OGinSx1eBb.bAXEGo6vXQI0VRhomlb3MW.D2Ch7Mnin3AnG1GYCwzuBTbpJ13bOszfgTPgg/E6PZo=")
...
kw = LineClient(authToken="EG77xdQ4R1Orpy0JONr9.sq7xakrN1v28/yW8CSq42q.hvNuXc0CC8lDzkLPvkLVKSDpEkIbk2jXcw0cNsrmDzE=")
...
ke = LineClient(authToken="EGJFuACeU0sw0r8JRX32.XhCwJBakhq3WIw4uZqu08G.z7q0g96+5epKTiAMuyT1A+5oGo8VgH49kjopLOBRg4U=")
...
ky = LineClient(authToken="EGGClmQirMaJ0F8k82Zc.CCslx0hiYMYz0Wkvw5ctJa.ctRkOS2hBFAyIdSuSG94pagmQRha4jzxQdgb/DACxpo=")
...
sw = LineClient(authToken="EGLzQBM8NA4AfM6sfb77.4ciXpOp+ngV1ye23dcM5vW.S/kTLzg1S9zGdNQdLdcSu9JQ3FkVl8c30aNBxIhqmDg=")
...
sx = LineClient(authToken="EGr1wIZYFwsBaxAQZ747.8d+/mNO13JPYidbljC3nvW.MU6tSIUoyfKFCJ5ZqJsffElS+JKI9/huIKZNIOSSNhQ=")
...
js = LineClient(authToken="EGZbg9q4XATCA8uCvqWe.yDd/ESRdVqhoxLV9ogigNG.Jq/aRz+Raef8WQE3ZjeAPzjCg5SXuU6sGpu4KThcroM=")
...
poll = LinePoll(cl)
call = cl
creator = ["uc0ec54b277eb5e38f86394cf9676f202"]
owner = ["uc0ec54b277eb5e38f86394cf9676f202"]
admin = ["uc0ec54b277eb5e38f86394cf9676f202"]
staff = ["uc0ec54b277eb5e38f86394cf9676f202"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
                 ...
                 if msg._from in admin:
                  if wait["addbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        cl.sendMessage(msg.to,"The contact is already on the bot member")
                        wait["addbots"] = True
                    else:
                        Bots.append(msg.contentMetadata["mid"])
                        wait["addbots"] = True
                        cl.sendMessage(msg.to,"Succeeded Promoted to member bot")
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        Bots.remove(msg.contentMetadata["mid"])
                        cl.sendMessage(msg.to,"Succeeded Removed from member bot")
                    else:
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"Contact itu bukan member bot Dpk")
#ADD STAFF
                 if msg._from in admin:
                  if wait["addstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        cl.sendMessage(msg.to,"Contact itu sudah to staff")
                        wait["addstaff"] = True
                    else:
                        staff.append(msg.contentMetadata["mid"])
                        wait["addstaff"] = True
                        cl.sendMessage(msg.to,"Succeeded Promoted ke staff")
                 if wait["dellstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        staff.remove(msg.contentMetadata["mid"])
                        cl.sendMessage(msg.to,"Succeeded Removed from staff")
                        wait["dellstaff"] = True
                    else:
                        wait["dellstaff"] = True
                 ...
                 if msg._from in admin:
                  if wait["addadmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        cl.sendMessage(msg.to,"Contact itu sudah to admin")
                        wait["addadmin"] = True
                    else:
                        admin.append(msg.contentMetadata["mid"])
                        wait["addadmin"] = True
                        cl.sendMessage(msg.to,"Succeeded Promoted ke admin")
                 if wait["delladmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        admin.remove(msg.contentMetadata["mid"])
                        cl.sendMessage(msg.to,"Succeeded Removed from admin")
                    else:
                        wait["delladmin"] = True
                 ...
                 if msg._from in admin:
                  if wait["wblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["wblacklist"] = True
                        cl.sendMessage(msg.to,"Succeeded Promoted ke blacklist user")
                  if wait["dblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        del wait["blacklist"][msg.contentMetadata["mid"]]
                        cl.sendMessage(msg.to,"Succeeded Removed from blacklist user")
                    else:
                 ...
                 if msg._from in admin:
                  if wait["Talkwblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["Talkblacklist"]:
                        ...
                        wait["Talkwblacklist"] = True
                        cl.sendMessage(msg.to,"Succeeded Promoted ke Talkban user")
                  if wait["Talkdblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["Talkblacklist"]:
                        del wait["Talkblacklist"][msg.contentMetadata["mid"]]
                        cl.sendMessage(msg.to,"Succeeded Removed from Talkban user")
                    else:
                 ...
                 if msg._from in admin:
                    if Setmain["Addimage"] == True:
                        ...
                        if r.status_code == 200:
                            ...
                            cl.sendText(msg.to, "Succeeded Promoted gambar")
                        Setmain["Img"] = {}
               ...
               if msg.toType == 2:
                 if msg._from in admin:
                   if settings["groupPicture"] == True:
                     ...
                     cl.sendMessage(msg.to, "Succeeded mengubah foto group")
               ...
               if msg.contentType == 1:
                   if msg._from in admin:
                       if mid in Setmain["ARfoto"]:
                            ...
                            cl.sendMessage(msg.to,"Foto Succeeded dirubah")
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                   if settings["changePicture"] == True:
                     ...
                     ki.sendMessage(msg.to, "Succeeded mengubah foto profile bot")
                     kk.updateProfilePicture(path2)
                     kk.sendMessage(msg.to, "Succeeded mengubah foto profile bot")
                     kc.updateProfilePicture(path3)
                     kc.sendMessage(msg.to, "Succeeded mengubah foto profile bot")
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               if key in [""," ","\n",None]:
                                   cl.sendMessage(msg.to, "Failed replace key")
                               else:
                                   Setmain["keyCommand"] = str(key).lower()
                                   cl.sendMessage(msg.to, "「Setkey」\nSetkey replaced to「{}」".format(str(key).lower()))
                          ...
                          if msg._from in admin:
                            ...
                            for i in group:
                                ...
                                if ginfo == group:
                                    ...
                                    ke.leaveGroup(i)
                                    ky.leaveGroup(i)
                                    cl.sendMessage(msg.to,"Successfully exited the group " +str(ginfo.name))
...
#===========BOT UPDATE============#
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kk.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kc.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                km.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kb.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kn.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                ko.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                kw.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                ke.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                ky.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                js.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                sw.sendMessage(msg.to,"Nama replaced to " + string + "")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                sx.sendMessage(msg.to,"Nama replaced to " + string + "")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"◄━━◈⟦Daftar__Admin⟧◈━━► \n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」 member" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    member = [Bmid,Cmid,Amid]
                                    cl.inviteIntoGroup(msg.to, member)
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ki.sendMessage(i, "Please admin invite or enter again")
                                        ki.leaveGroup(i)
                                        kk.leaveGroup(i)
                                        kc.leaveGroup(i)
                                        km.leaveGroup(i)
                                        ...
                                        ke.leaveGroup(i)
                                        ky.leaveGroup(i)
                                        cl.sendMessage(to,"Successfully exited the group " +h)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendText(msg.to, "Lurking Succeeded activated\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                 ...
                                 cl.sendText(msg.to, "Lurking Succeeded deactivated\n\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                Setmain["ARlimit"] = num
                                cl.sendText(msg.to,"Total Spamtag Diubah Mento " +strnum)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                wait["limit"] = num
                                cl.sendText(msg.to,"Total Spamcall Diubah Mento " +strnum)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                             if msg.toType == 2:
                                ...
                                jmlh = int(wait["limit"])
                                cl.sendMessage(msg.to, "Succeeded mengundang {} undangan Call Grup".format(str(wait["limit"])))
                                if jmlh <= 1000:
                                  for x in range(jmlh):
                                     try:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           admin.append(target)
                                           cl.sendMessage(msg.to,"Succesfully Promoted admin")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           staff.append(target)
                                           cl.sendMessage(msg.to,"Succeeded Promoted staff")
                                       except:
                                           pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           Bots.append(target)
                                           cl.sendMessage(msg.to,"Succeeded Promoted bot")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                   if target not in Dpk:
                                       try:
                                           admin.remove(target)
                                           cl.sendMessage(msg.to,"Succeeded Removed admin")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                                ...
                                cl.sendText(msg.to,"Succeeded Refresh...")
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = True
                                cl.sendText(msg.to,"Detection contact activated")

                        elif cmd == "contact off" or text.lower() == 'contact off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["contact"] = False
                                cl.sendText(msg.to,"Detection contact deactivated")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = True
                                cl.sendText(msg.to,"Detection sticker activated")

                        elif cmd == "sticker off" or text.lower() == 'sticker off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["sticker"] = False
                                cl.sendText(msg.to,"Detection sticker deactivated")
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           cl.sendMessage(msg.to,"Succeeded Promoted blacklist")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           cl.sendMessage(msg.to,"Succeeded Removed blacklist")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                               ...
                               for target in targets:
                                       try:
                                           ...
                                           cl.sendMessage(msg.to,"Succee blacklist")
                                       except:
                                           pass
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"ᖇαѕ¢αℓ Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"ᖇαѕ¢αℓ Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
